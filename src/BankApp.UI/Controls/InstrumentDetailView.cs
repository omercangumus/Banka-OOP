...
namespace BankApp.UI.Controls
{
    public class InstrumentDetailView : XtraUserControl
    {
        ...
        {
            // Chart disabled due to DevExpress compatibility issue
            // Use "Analiz" button for full chart functionality
            lblChartLoading.Text = "📊 Detaylı grafik için '⛶ Analiz' butonuna tıklayın";
            lblChartLoading.Appearance.Font = new Font("Segoe UI", 14F, FontStyle.Bold);
            lblChartLoading.Appearance.ForeColor = Color.FromArgb(156, 39, 176);
            lblChartLoading.Visible = true;
            lblChartLoading.BringToFront();
        }
